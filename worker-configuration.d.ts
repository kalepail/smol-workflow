/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 16ed427c99669985d5de72f585a017e4)
// Runtime types generated with workerd@1.20260103.0 2025-09-25 nodejs_compat

// KALE_WORKER RPC types (manually maintained until kale-worker is deployed)
interface KaleWorkerSubmitTransactionResult {
...
interface KaleWorkerService {
	submitTransaction(params: { xdr?: string; func?: string; auth?: string[] }): Promise<KaleWorkerSubmitTransactionResult>;
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "SmolDurableObject" | "SmolState";
	}
	interface Env {
		SMOL_KV: KVNamespace;
		...
		DURABLE_OBJECT: DurableObjectNamespace<import("./src/index").SmolDurableObject>;
		DO_STATE: DurableObjectNamespace<import("./src/index").SmolState>;
		SMOL_BUCKET: R2Bucket;
		SMOL_D1: D1Database;
		AISONGGENERATOR: Fetcher /* aisonggenerator-worker */;
		KALE_WORKER: KaleWorkerService /* kale-worker - RPC service binding */;
		AI: Ai;
		WORKFLOW: Workflow<Parameters<import("./src/index").Workflow['run']>[0]['payload']>;
		TX_WORKFLOW: Workflow<Parameters<import("./src/index").TxWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RPC_URL" | "RPC_URL_TESTNET" | "NETWORK_PASSPHRASE" | "SMOL_CONTRACT_ID">> {}
}
